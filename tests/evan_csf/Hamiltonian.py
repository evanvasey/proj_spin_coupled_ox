...
from CSF_tools import normalise_coeffs_det,overlap_CSF,overlap_matrix_CSF,cumul_coeff
...
def get_Ecurve_CSF_RHF(r_array,RHF_states,list_CSF_dets,list_CSF_coeffs,molecule_func,HF_coeffs=None,number_sloc_states=None,sloc_grouped=False,get_sloc_func=get_sloc_empty,RHF_states_grouped=False,bond_length=None,savetxt=None):
    ...
    for i,r in enumerate(r_array):
        ...
        #print(RHF_dets_list)
        RHF_dets_list2,RHF_coeffs_list2 = get_RHF_state(RHF_states,hf_coeffs,lowdin_coeffs,overlap)
        #RHF_dets_list2 = RHF_dets_list2[0]
        #RHF_coeffs_list2 = RHF_coeffs_list2[0]
        #print(RHF_dets_list2)
        #print(RHF_coeffs_list2)
        #temp_RHF_dets =RHF_dets_list[0]+RHF_dets_list[1] 
        #temp_RHF_coeffs =RHF_coeffs_list[0]+RHF_coeffs_list[1] 
        ##RHF_dets_list,RHF_coeffs_list = cumul_coeff(RHF_dets_list[0]+RHF_dets_list[1],RHF_coeffs_list[0]+RHF_coeffs_list[1],1e-8)
        #RHF_dets_list,RHF_coeffs_list = normalise_coeffs_det(RHF_dets_list[0]+RHF_dets_list[1],RHF_coeffs_list[0]+RHF_coeffs_list[1],1e-8)
        #print(RHF_dets_list)
        #print(RHF_coeffs_list)
        #print(RHF_dets_list==RHF_dets_list2)
        #print(RHF_coeffs_list==RHF_coeffs_list2)
        #for i, (sub1, sub2) in enumerate(zip(RHF_dets_list, RHF_dets_list2)):
        #    if sub1 != sub2:
